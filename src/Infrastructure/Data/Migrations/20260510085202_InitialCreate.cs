    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviePersons", x => new { x.MovieId, x.PersonId, x.RoleType });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SeatRow = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TheaterSeats", x => new { x.TheaterId, x.SeatRow, x.SeatNumber });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shows_TheaterId_Date_StartTime",
                table: "Shows",
                columns: new[] { "TheaterId", "Date", "StartTime" },
                unique: true);
        }
